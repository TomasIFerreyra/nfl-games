...
HISTORICAL_AWARDS: List[Tuple[str, str, int, Optional[str], Optional[str]]] = [
    ...
    ("Tom Brady", "MVP", 2017, "OFFENSE", "NWE"),
    ...
    ("Curtis Martin", "OROY", 1995, "OFFENSE", "NWE"),
    ...
    ("Jerod Mayo", "DROY", 2008, "DEFENSE", "NWE"),
    ...
    ("Julian Edelman", "SUPER_BOWL_MVP", 2018, "OFFENSE", "NWE"),
    ("Nick Foles", "SUPER_BOWL_MVP", 2017, "OFFENSE", "PHI"),
    ("Tom Brady", "SUPER_BOWL_MVP", 2016, "OFFENSE", "NWE"),
    ("Von Miller", "SUPER_BOWL_MVP", 2015, "DEFENSE", "DEN"),
    ("Tom Brady", "SUPER_BOWL_MVP", 2014, "OFFENSE", "NWE"),
    ...
    ("Deion Branch", "SUPER_BOWL_MVP", 2004, "OFFENSE", "NWE"),
    ("Tom Brady", "SUPER_BOWL_MVP", 2003, "OFFENSE", "NWE"),
    ("Dexter Jackson", "SUPER_BOWL_MVP", 2002, "DEFENSE", "TAM"),
    ("Tom Brady", "SUPER_BOWL_MVP", 2001, "OFFENSE", "NWE"),
    ...
    ("Stephon Gilmore", "FIRST_TEAM_ALL_PRO", 2019, "DEFENSE", "NWE"),
    ...
    ("Rob Gronkowski", "FIRST_TEAM_ALL_PRO", 2017, "OFFENSE", "NWE"),
