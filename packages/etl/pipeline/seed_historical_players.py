...
HOF_PLAYERS = [
    ...
    ("Tom Brady",         "QB",  2000, 2023, ["NWE", "TAM"]),
    ...
    ("Curtis Martin",     "RB",  1995, 2012, ["NWE", "NYJ"]),
    ...
    ("Randy Moss",        "WR",  1998, 2018, ["MIN", "LVR", "NWE", "TEN", "SFO"]),
    ...
    ("Henry Ellard",      "WR",  1983, 1999, ["LAR", "WAS", "NWE", "BAL", "NYJ"]),
    ...
    ("Junior Seau",       "LB",  1990, 2015, ["LAC", "MIA", "NWE"]),
    ...
    ("Nick Buoniconti",   "LB",  1962, 2001, ["NWE", "MIA"]),
    ...
    ("Darrelle Revis",    "CB",  2007, 2023, ["NYJ", "TAM", "NWE", "KC"]),
    ...
    ("Mike Haynes",       "CB",  1976, 1997, ["NWE", "LVR"]),
...
HISTORICAL_NON_HOF = [
    ...
    ("Steven Jackson",     "RB",  2004, False, ["LAR", "ATL", "NWE"]),
    ...
    ("Corey Dillon",       "RB",  1997, False, ["CIN", "NWE"]),
    ...
    ("Kerry Collins",      "QB",  1995, False, ["CAR", "NOR", "NYG", "LVR", "TEN", "IND", "NWE"]),
    ...
    ("Andre Carter",       "DE",  2001, False, ["SFO", "WAS", "NWE", "LVR"]),
    ("Shaun Ellis",        "DE",  2000, False, ["NYJ", "NWE"]),
    ...
    ("Cam Newton",         "QB",  2011, False, ["CAR", "NWE"]),
    ...
    ("Wes Welker",         "WR",  2004, False, ["MIA", "NWE", "DEN", "LAR"]),
    ("Reggie Wayne",       "WR",  2001, False, ["IND"]),
    ("Chad Johnson",       "WR",  2001, False, ["CIN", "NWE", "MIA"]),
    ("T.J. Houshmandzadeh","WR",  2001, False, ["CIN", "SEA", "BAL", "NYJ", "MIN"]),
    ("Donte Stallworth",   "WR",  2002, False, ["NOR", "PHI", "NWE", "CLE", "BAL", "WAS"]),
    ...
    ("Rob Gronkowski",     "TE",  2010, False, ["NWE", "TAM"]),
    ("Jimmy Graham",       "TE",  2010, False, ["NOR", "SEA", "GNB", "CHI"]),
    ("Vernon Davis",       "TE",  2006, False, ["SFO", "DEN", "WAS", "MIA"]),
    ("Martellus Bennett",  "TE",  2008, False, ["DAL", "NYG", "CHI", "NWE", "GNB"]),
    ...
    ("Chandler Jones",     "DE",  2012, False, ["NWE", "ARI", "LVR"]),
    ("Brandon Graham",     "DE",  2010, False, ["PHI"]),
    ("Calais Campbell",    "DE",  2008, False, ["ARI", "JAX", "BAL", "ATL", "MIA"]),
    ("Michael Bennett",    "DE",  2009, False, ["TAM", "SEA", "PHI", "NWE", "DAL"]),
    ...
    ("Aqib Talib",         "CB",  2008, False, ["TAM", "NWE", "DEN", "LAR", "MIA"]),
    ("Richard Sherman",    "CB",  2011, False, ["SEA", "SFO", "TAM"]),
    ("Stephon Gilmore",    "CB",  2012, False, ["BUF", "NWE", "CAR", "IND", "DAL"]),
